...
def list_scenario_templates(db: Session = Depends(get_db)) -> list[ScenarioTemplate]:
...
def delete_scenario_template(template_id: str, db: Session = Depends(get_db)) -> None:
